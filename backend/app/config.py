...
if GEMINI_API_KEY:
    ...
    print("⚠  GEMINI_API_KEY not found in .env — answer keys will use generic fallback.")

# MongoDB URI (read here so db.py can import it)
MONGODB_URI = os.getenv("MONGODB_URI")

if MONGODB_URI:
    print(f"✅ MONGODB_URI loaded ({MONGODB_URI[:20]}...)")
else:
    print("⚠  MONGODB_URI not found in .env — database features will be disabled.")

# Shared clients (created once, reused everywhere)
